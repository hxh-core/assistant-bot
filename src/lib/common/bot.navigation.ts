  ...
  user: {
    ...
    scenes: {
      ...
      settings: {
        enter: 'user-settings',
        notifications: {
          enter: 'user-settings-notifications',
          exit: 'user-settings-notifications-exit',
        },
        claimNotifications: {
          enter: 'user-settings-claim-notifications',
        },
        exit: {
          enter: 'user-settings-exit',
        },
      },
      site: {
        create: {
...
export const BotRoutes = {
  user: {
    ...
    settings: {
      ...
      claimNotifications: {
        value: 'user-settings-claim-notifications',
      },
      exit: {
        value: 'user-settings-exit',
      },
    },
    site: {
      choose: {
